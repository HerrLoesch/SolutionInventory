...
function getLogoPath(size) {
  if (size === 'icon') {
    return app.isPackaged ? path.join(__dirname, '../dist/icon.ico') : path.join(__dirname, '../public/icon.ico')
  }
      ...
      submenu: [
        {
          ...
          click: () => shell.openExternal('https://github.com/HerrLoesch/SolutionInventory')
        },
        { type: 'separator' },
